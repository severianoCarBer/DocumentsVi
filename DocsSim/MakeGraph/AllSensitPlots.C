...
//graph.SetTitle("Measurement XYZ;lenght [cm];Arb.Units");
  ...
  TGraphErrors *graph1 = new TGraphErrors("./Dats/DatsOrderedNeutSeve19.txt","%lg %lg %lg");
 graph1->SetTitle("CMS Sensitivity Simulation RE11;Energy (MeV);RPC sensitivity");
  ...
  TGraphErrors *graph2 = new TGraphErrors("./Dats/DatsOrderedGammaSeve19.txt","%lg %lg %lg");
