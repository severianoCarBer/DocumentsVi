...
//graph.SetTitle("Measurement XYZ;lenght [cm];Arb.Units");
  ...
  TGraphErrors *graph1 = new TGraphErrors("./iRPCSensiNeutron.txt","%lg %lg %lg");
 graph1->SetTitle("CMS Sensitivity Simulation RE11 vs iRPC;Energy (MeV);RPC sensitivity");
  ...
  TGraphErrors *graph2 = new TGraphErrors("./AliceSensiNeut.txt","%lg %lg %lg");
...
// Define a linear function
  ...
  // Build and Draw a legend
   ...
   leg->AddEntry("graph1","Seve iRPCs","P");
